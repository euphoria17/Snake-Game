...
class SNAKE:
    def __init__(self):
        ...
        def load_image(name):
            return pygame.image.load(f"Snake-patch-1/Graphics/{name}.png").convert_alpha()
        ...
        self.crunch_sound = pygame.mixer.Sound("Snake-patch-1/Sound/crunch.wav")
...
apple = pygame.image.load('Snake-patch-1/Graphics/apple.png').convert_alpha()
game_font = pygame.font.Font('Snake-patch-1/Font/PoetsenOne-Regular.ttf', 25)
